...
public class APIWorkflowSteps {
   ...
   @Given("a request is prepared to create an employee")
    ...
    //second call for getting the employee
    ...
    @Then("the employee we are getting having ID {string} must match with globally stored employee id")
    public void the_employee_we_are_getting_having_id_must_match_with_globally_stored_employee_id(String empId) {
