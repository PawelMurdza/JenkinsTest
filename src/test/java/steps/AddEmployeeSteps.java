...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void user_provides_multiple_employee_data_and_verify_they_are_added(DataTable dataTable) throws InterruptedException {
        ...
        for (Map<String, String> employee : employeeNames) {
            ...
            click(addEmployeePage.saveButton);
            Thread.sleep(2000);
            if (personalDetailsPage.FirstNameField.getText().equals(firstNameValue) && personalDetailsPage.MiddleNameField.getText().equals(middleNameValue) && personalDetailsPage.LastNameField.getText().equals(lastNameValue)) {
                System.out.println("Employee added successfully");
            } else {
                System.out.println("kurwa blad");
            }
